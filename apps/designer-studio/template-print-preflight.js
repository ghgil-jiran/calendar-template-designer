(()=>{
 const PAGE_ROLES=new Set(['cover','cover-inside','front-cover-inside','inside-cover','divider','divider-front','divider-back','front-divider','front-divider-front','front-divider-back','rear-divider','rear-divider-front','rear-divider-back','yearly-plan','school-symbol','school-introduction','academic-schedule','monthly-front','monthly-back','back-cover-inside','rear-cover-inside','back-cover','page']);
 const ELEMENT_TYPES=new Set(['text','image','image-frame','frame','shape','line','vector','graphic','calendar','calendar-grid','mini-calendar','mini-calendar-prev','mini-calendar-next','year-calendar','monthly-schedule','event-list','month-date-strip','monthly-quote','planner-goal','planner-weekly','planner-checklist','memo']);
 const STYLE_KEYS=new Set(['fontFamily','fontSize','fontWeight','fontStyle','lineHeight','letterSpacing','textAlign','verticalAlign','color','background','backgroundColor','border','borderColor','borderWidth','borderStyle','borderRadius','opacity','rotation','rotate','transform','boxShadow','shadow','fit','objectFit','objectPosition','focalPoint','clipPath','mask','overflow','zIndex','legacyRole','padding','paddingTop','paddingRight','paddingBottom','paddingLeft']);

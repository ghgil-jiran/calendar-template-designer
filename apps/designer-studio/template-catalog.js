window.ACDL_TEMPLATE_CATALOG={
  ...
  templates:[
    ...
    {id:"tpl-2028-wall-academic-standard-v0-1",name:"벽걸이형 표준 01 · 이미지 월력형",description:"A3 세로 표지 1면과 3월부터 다음 해 2월까지 사진+월력 12면을 편집·저장하는 review Sample Template입니다.",type:"wall",status:"ready",edition:2028,template:"wall-academic-standard",packageVersion:"0.1.0",packageBase:"/templates/wall-academic-standard/0.1.0/",features:["A3 세로 13면","상단 월별 이미지","단면 월력"],pageSummary:"표지 1면·월력 12면",updatedAt:"2026-08-24T00:00:00.000Z",version:1},

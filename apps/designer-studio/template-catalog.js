window.ACDL_TEMPLATE_CATALOG={
  ...
  templates:[
    {id:"tpl-2028-desk-academic-standard-v1-2",name:"학사달력 표준 탁상형 · Runtime 정밀형",description:"사용자 서비스 대표 28면과 Runtime 비교로 확정한 정밀 배치 계약과 교체 가능한 샘플 사진을 사용하는 review Sample Template입니다.",type:"desk",status:"ready",edition:2028,template:"desk-academic-standard",packageVersion:"1.2.0",packageBase:"/templates/desk-academic-standard/1.2.0/",features:["28면 표준 순서","교체 가능한 샘플 사진","정밀 layoutContract","5×7 월력"],pageSummary:"표지·연간·학교 상징·월력 12면·사진/메모 12면·끝지",updatedAt:"2026-08-27T00:00:00.000Z",version:2},
    {id:"tpl-2028-wall-academic-standard-v0-2",name:"벽걸이형 표준 01 · 이미지 월력형",description:"A3 세로 앞표지 1면·앞간지 1면·3월부터 다음 해 2월까지 사진+월력 12면·뒷표지 1면에 교체 가능한 샘플 사진을 포함한 review Sample Template입니다.",type:"wall",status:"ready",edition:2028,template:"wall-academic-standard",packageVersion:"0.2.0",packageBase:"/templates/wall-academic-standard/0.2.0/",features:["A3 세로 15면","교체 가능한 샘플 사진","앞간지·뒷표지","상단 월별 이미지","단면 월력"],pageSummary:"앞표지 1면·앞간지 1면·월력 12면·뒷표지 1면",updatedAt:"2026-08-27T00:00:00.000Z",version:2},

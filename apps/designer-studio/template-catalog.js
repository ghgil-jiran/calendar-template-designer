window.ACDL_TEMPLATE_CATALOG={
  ...
  templates:[
    {id:"tpl-2028-desk-academic-standard-v1-3",name:"학사달력 표준 탁상형 · Runtime 정밀형",description:"실제 이미지 개체의 기본 샘플과 사용자가 사진 보관함에서 직접 교체하는 28면 review Sample Template입니다.",type:"desk",status:"ready",edition:2028,template:"desk-academic-standard",packageVersion:"1.3.0",packageBase:"/templates/desk-academic-standard/1.3.0/",features:["28면 표준 순서","이미지 개체 기본 샘플","사용자 수동 사진 선택","정밀 layoutContract"],pageSummary:"표지·연간·학교 상징·월력 12면·사진/메모 12면·끝지",updatedAt:"2026-08-27T00:00:00.000Z",version:3},
    {id:"tpl-2028-wall-academic-standard-v0-3",name:"벽걸이형 표준 01 · 이미지 월력형",description:"A3 세로 15면의 실제 이미지 개체에 기본 샘플을 포함하고 사용자가 사진 보관함에서 직접 교체하는 review Sample Template입니다.",type:"wall",status:"ready",edition:2028,template:"wall-academic-standard",packageVersion:"0.3.0",packageBase:"/templates/wall-academic-standard/0.3.0/",features:["A3 세로 15면","이미지 개체 기본 샘플","사용자 수동 사진 선택","학교 정보 Binding"],pageSummary:"앞표지 1면·앞간지 1면·월력 12면·뒷표지 1면",updatedAt:"2026-08-27T00:00:00.000Z",version:3},

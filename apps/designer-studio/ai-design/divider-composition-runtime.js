(function(root){
 ...
 function install(){
  ...
  card.id='dividerCompositionCard';card.className='settings-card';
  ...
  if(conditions)conditions.after(card);else page.appendChild(card);
 ...
 function render(){
  ...
  const spec=current(),items=targets(),layouts=root.ACDLDesignTypeCatalog.roles.divider.options;

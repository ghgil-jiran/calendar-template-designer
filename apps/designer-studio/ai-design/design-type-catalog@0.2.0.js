(function(root){
 const catalog=Object.freeze({id:'school-calendar-design-types',version:'0.2.0',schemaVersion:'design-type-catalog.v1',principle:'designer-finished-editable-start',styles:[
  ...
  'school-symbols':{label:'학교 상징',objects:'교표 · 교훈 · 교가 · 교목 · 교화',use:'학교 상징 정보를 읽기 쉬운 묶음으로 소개하는 면',caution:'교가는 악보 전체와 가사가 보이는 세로형 독립 영역을 우선 확보하고 임의로 자르지 않음',layout:'symbol-split',options:[['song-led-split','교가 우선 2열형'],['editorial-cards','에디토리얼 카드형'],['section-panels','섹션 분할형'],['heritage-document','전통 문서형'],['symbol-photo','상징 이미지 중심형']]},

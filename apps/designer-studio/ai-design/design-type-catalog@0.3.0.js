(function(root){
 ...
 const roles={
  ...
  annual:{label:'연력',objects:'연도 · 12개월 월력 · 월 이름 · 주말 색상',use:'표지 안쪽면·간지·뒷표지 안쪽면에 배치할 수 있는 연간 정보 구성',caution:'12개월 정보 영역을 이미지에 그리지 않음',layout:'annual-grid',options:[['balanced-4x3','4×3 균형형'],['open-grid','넓은 여백 격자형'],['header-band','상단 연도 띠형'],['split-info','월력·정보 분할형']]},

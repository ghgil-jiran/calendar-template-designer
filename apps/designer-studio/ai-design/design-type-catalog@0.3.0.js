(function(root){
 ...
 const catalog=Object.freeze({id:'school-calendar-design-types',version:'0.3.0',schemaVersion:'design-type-catalog.v2',scope:'desk-first',principle:'designer-finished-editable-start',commonGuideline,styles,expressionOptions:Object.freeze({variationRhythm:[['uniform','통일형'],['color','색상 변화형'],['seasonal','계절형'],['alternating','교대형'],['story','스토리형']],monthBackPhoto:[['use','사용'],['none','사용 안 함']],monthBackSeason:[['none','계절 장식 없음'],['subtle','은은한 계절 변화'],['seasonal','사계절 변화']]}),roles});

(()=>{
 ...
 function renderPreflightArtifact(identity,artifact){
  ...
  const groups=[
   ...
   {scope:'follow-up',label:'후속 품질검토',checks:[['재단영역 내용 동등성','trimContentParity'],['템플릿 이미지 배치·AI 이미지 조건부 검토','templateImageApproval']]},

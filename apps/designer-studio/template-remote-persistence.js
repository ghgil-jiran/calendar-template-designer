(function(root){
 ...
 async function packageIdentity(templateId){return request(`/api/template-package-preflight?action=identity&templateId=${encodeURIComponent(templateId)}`)}

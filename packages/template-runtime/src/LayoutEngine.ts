...
export class LayoutEngine {
 ...
 private normalizeCalendar(o:RenderNode){const p=(o.payload&&typeof o.payload==="object"?o.payload:{}) as Record<string,unknown>;o.payload={...p,rows:Number(p.rows??o.style.rows??6),columns:7,weekStart:String(p.weekStart??o.style.weekStart??"sunday"),showHolidays:p.showHolidays??true}}
}

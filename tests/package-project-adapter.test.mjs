...
const wallCoverImage = wallProject.book.elementsByPage[wallCover.id].find(item => item.id === 'wall.cover.school-image');
assert.match(wallCoverImage.src, /^data:image\/svg\+xml;base64,/);

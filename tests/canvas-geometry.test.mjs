...
assert.deepEqual(moveFrame(frame, 80, 90), { x: 60, y: 75 });
assert.deepEqual(moveFrame(frame, -50, -50), { x: 0, y: 0 });
...
assert.deepEqual(resizeFrame(frame, 'n', 0, -50), { x: 20, y: 0, width: 40, height: 75 });
...
assert.deepEqual(nudgeFrame({ x: 60, y: 75, width: 40, height: 25 }, .2, .2), { x: 60, y: 75 });

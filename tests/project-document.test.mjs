...
assert.equal(sampleThree.template.documentVersion, 2);
...
assert.deepEqual(migratedSampleThree.report.applied, ['desk-sample-3-photo-layouts-v2', 'desk-sample-3-document-version-2']);
assert.equal(migratedSampleThree.project.template.documentVersion, 2);

...
assert.equal(template.masterDefinitions["cover-front"].find((item) => item.id === "wall.cover.year").format, "year-plain");
assert.equal(template.masterDefinitions["cover-front"].find((item) => item.id === "wall.cover.calendar-label").content, "CALENDAR");

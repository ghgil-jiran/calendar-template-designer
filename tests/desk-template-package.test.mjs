...
assert.equal(manifest.status, 'print-review-ready');
assert.equal(template.extractionStatus, 'print-review-ready');
...
assert.equal(print.status, 'contract-verified-output-pending');
assert.equal(parity.visual.status, 'approved');
